            ...
            <div className="row g-0">
                <div className="col-lg-6 mb-3 ">
                    <div className="goal_content bg_bb">
                        ...
                        <p className="section_paragraph_dark">We deliver transparent, global financial solutions bridging traditional finance and digital assets, driving user-centric innovation and collaborative growth in decentralized finance.</p>
