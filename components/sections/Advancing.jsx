            ...
            <div className="row">
                <div className="col-lg-3">
                    <div className="advancing_content">
                        <h2 className="section_title_dark">
                            Advancing UCBI through <br /> strategic growth
                        </h2>
                    </div>   
                </div>
                ...
                <div className="offset-lg-4 col-lg-5">
                    ...
                    <div className="advancing_para">
                        ...
                        <p>A scalable and interoperable ecosystem that enables seamless connectivity, efficient expansion, and unified access across diverse digital and financial networks, built to support long-term innovation and global growth.</p>
                    </div>
                    <div className="advancing_para">
                        <h5>Partnerships Global Expansion</h5>
                        <p>Our strategy focuses on scaling operations in key markets through targeted market entry, regulatory alignment, and ecosystem-driven expansion. This approach ensures sustainable growth while strengthening long-term market presence.</p>
                    </div>
                </div>
